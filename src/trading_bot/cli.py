...
def cmd_doctor(args: argparse.Namespace) -> int:
    from trading_bot.bundle import bundle_root, is_editable_checkout
...
def cmd_data_pull(args: argparse.Namespace) -> int:
    from trading_bot.data.pull import run as pull_run
...
def cmd_paper(args: argparse.Namespace) -> int:
    ...
    from trading_bot.live.paper import PaperTrader
...
def cmd_ledger(args: argparse.Namespace) -> int:
    from trading_bot.research.ledger.query import summarise
    from trading_bot.research.ledger.registry import LEDGER_DIR, TRIALS_FILE, load_ledger
