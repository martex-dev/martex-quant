"""Live/dry-run trading against MT5.
    ...
    python -m martex_quant.live.trade --strategy vol-target             # DRY RUN
    python -m martex_quant.live.trade --strategy vol-target --live      # real orders
...
from martex_quant.live import decision
...
def run_once(
    ...
    if guard_root is not None:
        from martex_quant.live.guard import is_halted
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(prog="python -m martex_quant.live.trade")
