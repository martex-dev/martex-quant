"""Milestone 1 deliverable::
    ...
    python -m martex_quant.data.pull --symbol BTCUSDT --interval 1h --years 4
...
from martex_quant.data.processors.validation import ValidationReport, validate_ohlcv
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        prog="python -m martex_quant.data.pull",
