"""CLI: run the TSLA CNN direction study end to end.
    ...
    python -m martex_quant.research.tesla.run --csv data/Tesla/Tasla_Stock_Updated_V2.csv
...
from martex_quant.research.tesla.dataset import NEUTRAL, Dataset, build_dataset, load_bars
from martex_quant.research.tesla.evaluate import (
    DEFAULT_COST_BPS,
    FoldResult,
    aggregate,
...
from martex_quant.research.tesla.model import (
    Classifier,
    CNNClassifier,
    CNNConfig,
...
from martex_quant.research.tesla.splits import Fold, validation_tail, walk_forward_folds
